  ...
  Widget build(BuildContext context) {
    return Layout(
      ...
      children: [
        ...
        SpacerV(100),
        ProductHorizontalList(type: ProductHorizontalListType.cloth,),
        // _item(title: 'Pet cloths', items: petCloth),
        SpacerV(100),
        ProductHorizontalList(type: ProductHorizontalListType.food,),
        SpacerV(100),
        ProductHorizontalList(type: ProductHorizontalListType.cat,),
        // _item(title: 'Pet foodies', items: petFood),
        SpacerV(100),
        _midBanner(),
        SpacerV(100),
        ProductHorizontalList(type: ProductHorizontalListType.dog,),
